...
from src.batch import MemoryAwareBatcher, BatchProcessor, BatchStrategy, BatchConfig
...
def demo_memory_optimization_strategies():
    ...
    for strategy_name, params in strategies:
        ...
        print(f"Memory limit: {params['max_memory_mb']}MB, "
              f"Min batch size: {params['min_batch_size']}")
