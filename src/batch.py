...
class MemoryAwareBatcher:
    ...
    def calculate_optimal_batch_size(self, sample_size_bytes: int) -> int:
        ...
        available_memory_bytes = (memory_info.available_mb * (1 - self._safety_margin)) * 1024 * 1024
...
class BatchProcessor:
    ...
    def _round_robin_batching(self, param_generator: Generator) -> Generator[list[dict], None, None]:
    ...
    def _memory_optimized_batching(self, param_generator: Generator) -> Generator[list[dict], None, None]:
        ...
        for params in param_generator:
            ...
            if len(batch) % 10 == 0:  # Check every 10 items
                ...
                optimal_size = self._memory_batcher.adjust_batch_size(
                    len(batch), memory_usage
                )
    ...
    def _adaptive_batching(self, param_generator: Generator) -> Generator[list[dict], None, None]:
        ...
        for params in param_generator:
            ...
            memory_usage = self._memory_batcher.monitor_memory_usage()
            memory_adjusted_size = self._memory_batcher.adjust_batch_size(
                target_size, memory_usage
            )
