...
class TestBenchmarkRunner:
    ...
    def test_benchmark_generation_execution(self):
        ...
        assert len(runner._results_history) == 0  # History is only updated in compare_configurations
    ...
    def test_benchmark_measurement_accuracy(self):
        ...
        throughput_ratio = max(metrics1.throughput_samples_per_second, metrics2.throughput_samples_per_second) / \
    ...
    def test_benchmark_error_handling(self):
        ...
        configs = [
            {'name': 'invalid', 'type': 'unknown_type', 'num_samples': 5}
        ]
